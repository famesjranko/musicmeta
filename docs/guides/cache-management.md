...
| Category | TTL | Types |
|----------|-----|-------|
| Statistics | 7 days | `TRACK_POPULARITY`, `ARTIST_POPULARITY`, `ARTIST_RADIO`, `ARTIST_TOP_TRACKS` |
...
| Artwork | 90 days | `ALBUM_ART`, `ARTIST_LOGO`, `CD_ART`, `ARTIST_BANNER`, `ALBUM_ART_BACK`, `ALBUM_BOOKLET`, `GENRE`, `ALBUM_METADATA` |
