...
| Dynamic data | 30 days | `ARTIST_PHOTO`, `ARTIST_BACKGROUND`, `ARTIST_BIO`, `ALBUM_DESCRIPTION`, `SIMILAR_ARTISTS`, `SIMILAR_TRACKS`, `BAND_MEMBERS`, `CREDITS`, `ARTIST_DISCOGRAPHY`, `ARTIST_TIMELINE`, `SIMILAR_ALBUMS`, `GENRE_DISCOVERY` |
| Artwork and slow-moving facts | 90 days | `ALBUM_ART`, `ARTIST_LOGO`, `CD_ART`, `ARTIST_BANNER`, `ALBUM_ART_BACK`, `ALBUM_BOOKLET`, `GENRE`, `ALBUM_METADATA`, `TRACK_METADATA`, `LYRICS_SYNCED`, `LYRICS_PLAIN`, `ARTIST_LINKS` |
