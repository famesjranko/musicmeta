...
abstract class EnrichmentCacheDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Builds this database with every registered migration applied, so an on-device v1-v3 file
         ...
         * registering [MIGRATION_1_2], [MIGRATION_2_3], and [MIGRATION_3_4] by hand.
         */
