 ...
 * identifiers overwhelmingly come from — and a dead one is not a corner case, per the measurement
 * on [EnrichmentRequest.forAlbumByMbid]. `docs/how-it-works.md` records the ListenBrainz
 * alternative that was measured against this ordering and lost.
 *
