...
class DefaultEnrichmentEngineTest {
    ...
    @Test fun `a NotFound under a SUGGESTIONS canonical outcome is not negative-cached`() = runTest {
        ...
        val cacheable = e.isCacheableNegative(result, CanonicalStatus.AMBIGUOUS, identifierIncomplete = false, filterEmptied = false)
    ...
    @Test fun `a NotFound under an UNVERIFIED canonical outcome is not negative-cached`() = runTest {
        ...
        // When - checking whether the result is cacheable as a negative
        val cacheable = e.isCacheableNegative(result, CanonicalStatus.FAILED, identifierIncomplete = false, filterEmptied = false)
    ...
    @Test fun `an identifier-incomplete NotFound under a RESOLVED identity is not negative-cached`() = runTest {
        ...
        // When - checking whether the result is cacheable as a negative
        val cacheable = e.isCacheableNegative(result, CanonicalStatus.RESOLVED, identifierIncomplete = true, filterEmptied = false)
    ...
    @Test fun `a complete exhausted chain under a RESOLVED identity remains negative-cacheable`() = runTest {
        ...
        // When - checking whether the result is cacheable as a negative
        val cacheable = e.isCacheableNegative(result, CanonicalStatus.RESOLVED, identifierIncomplete = false, filterEmptied = false)
    ...
    @Test fun `a NotFound with no canonical resolution attempted remains negative-cacheable`() = runTest {
        ...
        // When - checking whether the result is cacheable as a negative
        val cacheable = e.isCacheableNegative(result, CanonicalStatus.NOT_ATTEMPTED_NOT_REQUIRED, identifierIncomplete = false, filterEmptied = false)
