...
class MergerNormalisationProbeTest {
    ...
    fun `known single-provider case matches hand-computed scores`() {
        ...
        // Control/Arm A: raw scores pass through unchanged for a single contributor.
        org.junit.Assert.assertEquals(0.9f, merged[0].matchScore, EPS)
        org.junit.Assert.assertEquals(0.6f, merged[1].matchScore, EPS)
        org.junit.Assert.assertEquals(0.2f, merged[2].matchScore, EPS)
    }
