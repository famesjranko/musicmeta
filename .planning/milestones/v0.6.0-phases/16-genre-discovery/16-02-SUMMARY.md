...
- FOUND: `musicmeta-core/src/main/kotlin/com/landofoz/musicmeta/EnrichmentEngine.kt`
- FOUND: `musicmeta-core/src/test/kotlin/com/landofoz/musicmeta/engine/BuilderDefaultProvidersTest.kt`
- FOUND: `.planning/phases/16-genre-discovery/16-02-SUMMARY.md`
- FOUND: commit `4b663d1` (Task 1 — Builder wiring)
- FOUND: commit `82063c6` (Task 2 — BuilderDefaultProvidersTest update)
- FOUND: commit `af2e1b0` (metadata/docs)
