...
`ARCHITECTURE.md`, `VERIFICATION.md`, `CONTRIBUTING.md`, `SECURITY.md`, `CODE_OF_CONDUCT.md`. The
`.github/` issue and PR templates are not in the table but ship to that same reader, so write them
for it. Everything outside it is ours: this file, `docs/pitfalls.md`,
