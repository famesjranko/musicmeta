...
- **42 of the 55 routes are pinned to nothing, and the check that counts them cannot say which are
  merely unattributed.** `check_route_pin_coverage.py` enumerates every route and requires each to
