...
- iTunes and Discogs artist search now rank a candidate pool by name match instead of taking hit 0 of a 1-result search, so a wrong-name hit is passed over rather than enriched
