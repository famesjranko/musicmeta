...
### Breaking Changes
- `WikipediaProvider.WIKIDATA_API` is removed: a Java-only constant naming a host this class no longer calls directly, so read `WikidataApi`'s route or hardcode the URL
