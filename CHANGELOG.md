...
- `SimilarArtist.matchScore` is now the entry's rank in its own merged list, top entry 1.0, not a sum clamped at 1.0: merged order and every score move, and a cached list reads on the old scale
