...
### Fixed
- Both demos find `secrets.properties` from inside a git worktree by following the worktree's `.git` pointer to the main checkout, instead of silently running keyless
