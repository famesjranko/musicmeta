...
- `CREDITS` now returns the songwriters, composers and lyricists MusicBrainz models on the work, which were silently dropped for every recording on every call
