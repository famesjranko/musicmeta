...
- `docs/providers.md` no longer promises a MusicBrainz album `SearchCandidate` a `thumbnailUrl`: a release search response has no cover-art flag, so that field was always null
