...
- A 429/5xx/network failure from Cover Art Archive, LRCLIB, Wikidata or Wikipedia is now `Error(ErrorKind.NETWORK)`, not an empty result; the breaker sees it and `STALE_IF_ERROR` engages
