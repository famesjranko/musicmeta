...
- A failing Cover Art Archive release lookup is now retried once per call, not once per artwork type: ALBUM_ART/ALBUM_ART_BACK/ALBUM_BOOKLET/CD_ART share one attempt budget, same results far sooner
